...
video = cv2.VideoCapture("Ressources/video1.avi")
...
while True :
    ...
    imageFilteredAndContours = cv2.drawContours(imageFilteredAndContours, contours, -1, (0, 0, 255), 2)

    imageStack = stackImages(0.5, ([imageBGR, mask, imageFilteredAndContours]))
